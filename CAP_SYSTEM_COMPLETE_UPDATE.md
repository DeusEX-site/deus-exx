...
2. Ответ: "STOP" (отвечаем на сообщение #1)
3. Ответ: "RUN" (можно отвечать на сообщение #2, но система найдет капу из #1)
4. Ответ: "DELETE" (можно отвечать на сообщение #3, но система найдет капу из #1)
5. Ответ: "RESTORE" (можно отвечать на сообщение #4, но система найдет капу из #1)
```
