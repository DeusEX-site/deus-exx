...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Загружаем чаты и фильтры, затем автоматически запускаем поиск
            loadChats();
            loadFilterOptions();
            
            // Автоматически запускаем поиск при загрузке страницы
            setTimeout(() => {
                console.log('Автоматический запуск поиска при загрузке страницы...');
                searchMessages();
            }, 1000); // Даем время для загрузки чатов и фильтров
        });
